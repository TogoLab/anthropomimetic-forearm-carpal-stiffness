...
stl/        3Dプリント用STLデータ（骨・指先モールド・TFCC・モータタワーとプーリ・組立／実験治具）
media/      補足動画
...
骨モデルと指先モールドは **BodyParts3D**（ライフサイエンス統合データベースセンター）に由来するため **CC BY-SA 2.1 JP**、それ以外の著者らによるオリジナルデータは **CC BY 4.0** で提供されます。  
